...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/ubuntu/quad_suspended/AutoTrans/autotrans_ws/src/Utils/rviz_plugins)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/quad_suspended/AutoTrans/autotrans_ws/src/Utils/rviz_plugins/${idir}'.  ${_report}")
    endif()
