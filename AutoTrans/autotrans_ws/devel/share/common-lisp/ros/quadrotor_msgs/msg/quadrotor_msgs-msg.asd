...
(defsystem "quadrotor_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "PolynomialMatrix" :depends-on ("_package_PolynomialMatrix"))
    (:file "_package_PolynomialMatrix" :depends-on ("_package"))
    (:file "PolynomialTraj" :depends-on ("_package_PolynomialTraj"))
    (:file "_package_PolynomialTraj" :depends-on ("_package"))
